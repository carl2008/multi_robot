...
def goToPose():
    pub_gotopose1 = rospy.Publisher('/robot1/move_base/goal', PoseStamped)
    pub_gotopose2 = rospy.Publisher('/robot2/move_base/goal', PoseStamped)
    ...
    pub_gotopose1.publish(target_pose)
    pub_gotopose2.publish(target_pose)
